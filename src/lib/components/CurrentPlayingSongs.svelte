...
<style>
  .current-songs {
    --uno: 'fixed z-108 left-[100%] bg-white dark:bg-dark-9 top-0 bottom-0 overflow-y-auto w-[70vw] sm:w-[60vw] md:w-[50vw] lg:w-[40vw] min-w-[320px] transition-transform transition-300';
  }
  .fullscreen {
