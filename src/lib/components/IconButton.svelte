...
<style>
  .icon-button {
    --uno: 'cursor-pointer flex items-center hover:bg-primary hover:bg-opacity-8 active:bg-opacity-16 dark:hover:bg-opacity-20 dark:active:bg-opacity-30 p-2 rounded-[20px] relative z-3 pointer-events-auto';
